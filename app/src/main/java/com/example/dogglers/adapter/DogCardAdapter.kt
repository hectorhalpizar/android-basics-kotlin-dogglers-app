...
class DogCardAdapter(
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        DataSource.dogs[position].let { dog ->
            holder.dogName.text = dog.name
            holder.dogAge.text = String.format(context?.getText(R.string.dog_age).toString(), dog.age)
            holder.dogHobbies.text = String.format(context?.getText(R.string.dog_hobbies).toString(), dog.hobbies)
